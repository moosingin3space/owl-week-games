export default {
    'questions': [
        {
            ...
            'attribution': {
                ...
                'webpage': 'https://www.flickr.com/photos/7232686@N03/3967113235',
                'author': {
                    'name': 'mek22',
                    'profile': 'https://www.flickr.com/photos/7232686@N03'
                },
                'license': {
                    'name': 'CC-BY-NC-SA 2.0',
                    'link': 'https://creativecommons.org/licenses/by-nc-sa/2.0/?ref=ccsearch&atype=html'
                },
        ...
        },
        {
            ...
            'attribution': {
                'title': 'Summer',
                'webpage': 'https://www.flickr.com/photos/52645838@N00/35593986991',
                'author': {
                    'name': 'simplethrill',
                    'profile': 'https://www.flickr.com/photos/52645838@N00'
                },
                'license': {
                    'name': 'CC-BY-NC-ND 2.0',
                    'link': 'https://creativecommons.org/licenses/by-nc-nd/2.0/?ref=ccsearch&atype=html'
                },
                "modifications": "Cropped from original"
            },
            'answers': [
        ...
        },
        {
            ...
            'attribution': {
                'title': 'Castle',
                'webpage': 'https://www.flickr.com/photos/26234859@N07/5982384567',
                'author': {
                    'name': 'milan.boers',
                    'profile': 'https://www.flickr.com/photos/26234859@N07'
                },
                'license': {
                    'name': 'CC-BY 2.0',
                    'link': 'https://creativecommons.org/licenses/by/2.0/?ref=ccsearch&atype=html'
                },
                "modifications": "Cropped from original"
            },
            'answers': [
        ...
        },
        {
            ...
            'attribution': {
                'title': 'Career',
                'webpage': 'https://www.flickr.com/photos/144008357@N08/45854121975',
                'author': {
                    'name': 'Got Credit',
                    'profile': 'https://www.flickr.com/photos/144008357@N08'
                },
                'license': {
                    'name': 'CC-BY 2.0',
                    'link': 'https://creativecommons.org/licenses/by/2.0/?ref=ccsearch&atype=html'
    ...
    'answers': {
        ...
        'stag': {
            ...
            'attribution': {
                'title': 'Red deer stag.jpg',
                'webpage': 'https://commons.wikimedia.org/wiki/File:Red_deer_stag.jpg',
                'author': {
                    'name': 'Mehmet Karatay',
                    'profile': 'https://commons.wikimedia.org/wiki/User:Mehmet_Karatay'
                },
                'license': {
                    'name': 'CC-BY-SA 3.0',
        ...
        'swan': {
            ...
            'attribution': {
                'title': 'Mute swan (20608).jpg',
                'webpage': 'https://commons.wikimedia.org/wiki/File:Mute_swan_(20608).jpg',
                'author': {
                    'name': 'Rhododendrites',
                    'profile': 'https://commons.wikimedia.org/wiki/User:Rhododendrites'
                },
                'license': {
                    'name': 'CC-BY-SA 4.0',
        ...
        'otter': {
            ...
            'attribution': {
                ...
                'webpage': 'https://commons.wikimedia.org/wiki/File:Sea-otter-morro-bay_13.jpg',
                'author': {
                    'name': 'Mike Baird',
                    'profile': 'https://www.flickr.com/people/72825507@N00'
                },
                'license': {
                    'name': 'CC-BY 2.0',
        ...
        'cat': {
            ...
            'attribution': {
                ...
                'webpage': 'https://commons.wikimedia.org/wiki/File:Cat_November_2010-1a.jpg',
                'author': {
                    'name': 'Alvesgaspar',
                    'profile': 'https://commons.wikimedia.org/wiki/User:Alvesgaspar'
                },
                'license': {
                    'name': 'CC-BY-SA 3.0',
                    'link': 'https://creativecommons.org/licenses/by-sa/3.0/deed.en'
        ...
        'inconclusive': {
            'text': "You are a unique individual!"
        }
    }
};